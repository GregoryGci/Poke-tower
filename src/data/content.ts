...
export const SPECIES: Record<string, Species> = {
  ...
  mudkip: {
    ...
    range: 3, style: 'cac', movepool: ['charge', 'pistolet_a_o', 'morsure', 'jet_de_sable'],
  ...
  pidgey: {
    ...
    range: 9, style: 'unique', movepool: ['charge', 'tornade', 'jet_de_sable'],
  ...
  zigzagoon: {
    ...
    range: 3.4, style: 'cac', movepool: ['charge', 'morsure', 'jet_de_sable'],
  ...
  poochyena: {
    ...
    range: 3.2, style: 'cac', movepool: ['charge', 'morsure', 'jet_de_sable'],
