...
const BASES: Record<string, Species> = {
  ...
  // --- Prismatiques du portail à cristaux
  //
  ...
  // portail de Minidraco sans intérêt. Ils s'obtiennent donc directement, au
  // taux prismatique — assez rare pour rester un événement, assez atteignable
  // pour se viser.
  dragonite: {
    id: 'dragonite', dexNumber: 149, name: 'Dracolosse', types: ['dragon', 'vol'],
    baseStats: stats(91, 134, 95, 100, 100, 80), rarity: 'prismatique',
  ...
  tyranitar: {
    ...
    baseStats: stats(100, 134, 110, 95, 100, 61), rarity: 'prismatique',
  ...
  salamence: {
    ...
    baseStats: stats(95, 135, 80, 110, 80, 100), rarity: 'prismatique',
  ...
  metagross: {
    ...
    baseStats: stats(80, 135, 130, 95, 90, 70), rarity: 'prismatique',
  ...
  garchomp: {
    ...
    baseStats: stats(108, 130, 95, 80, 85, 102), rarity: 'prismatique',
...
interface StadeEvolue {
   ...
   *
   * Un seul cas aujourd'hui : Dracaufeu. Il figure au portail à cristaux
   * comme prismatique, et une espèce ne peut avoir qu'une rareté — c'est la
   * règle du jeu. Le faire monter d'un cran au dernier stade est plus juste
   * que de dédoubler l'espèce : évoluer un Salamèche jusqu'au bout rapporte
   * alors exactement ce que le portail vend.
   */
  rarity?: Rarity;
...
const LIGNEES: Record<string, StadeEvolue[]> = {
  ...
  charmander: [
    ...
    { id: 'charizard', dexNumber: 6, name: 'Dracaufeu', types: ['feu', 'vol'], baseStats: stats(78, 84, 78, 109, 85, 100), height: 2.72, niveau: 36, rarity: 'prismatique' },
  ],
  squirtle: [
 ...
 */
/**
 * Espèces qui demandent une pierre.
 *
...
/**
 * Les huit légendes de la Master Ball.
 *
 * La liste est **écrite**, pas déduite d'un palier : elles partagent leur
 * rareté avec les six prismatiques du portail à cristaux, et ce qui les en
 * distingue n'est pas ce qu'elles valent mais où on les trouve. Un palier de
 * plus aurait prétendu le contraire.
 *
 * C'est toute la raison d'être de la Master Ball : les laisser aussi tomber
 * au portail ordinaire l'aurait vidée de son sens.
 */
export const ESPECES_LEGENDAIRES = [
  'mewtwo',
  'mew',
  'lugia',
  'ho-oh',
